...
export default function Database() {
  ...
  const { fetchDatabase, isLoading, total, database } = useDatabaseStore();
  const [filters, setFilters] = useState<FilterDatabase>({
  ...
  const handleFiltersChange = (newFilters: Partial<FilterDatabase>) => {
