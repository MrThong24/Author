  ...
  const columns = [
    ...
    },
    {
      ...
      render: (value: string) => {
        return (
          <p className="text-sm">
            {eInvoiceTypes.find((item) => item.value === value)?.label}
          </p>
        );
      },
    },
    {
      ...
      render: (value: string) => {
        return (
          <p className="text-sm">
            {eInvoiceFormats.find((item) => item.value === value)?.label}
          </p>
        );
      },
    },
    {
      ...
      render: (value: string) => {
        return (
          <p className="text-sm">
            {eInvoiceModes.find((item) => item.value === value)?.label}
          </p>
        );
      },
    },
  ...
  return (
    <div>
      <h1 className="text-lg font-semibold text-primary">
        Thông tin kết nối hóa đơn điện tử
      </h1>
      ...
      <div className="mt-10">
        <h1 className="text-lg font-semibold mb-2 text-primary">
          Thông tin cấu hình hóa đơn điện tử
        </h1>
