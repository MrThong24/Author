...
export default function ProductSetting() {
  ...
  const [detailProductSetting, setDetailProductSetting] =
    ...
    await updateStore(
      currentUser?.currentUserStore?.store?.id as string,
      {
        servingQuantityConfirmationDisabled:
          data?.servingQuantityConfirmationDisabled || false,
  ...
  return (
    <div>
            ...
            <Controller
              ...
              defaultValue={
                currentUser?.currentUserStore?.store
                  ?.servingQuantityConfirmationDisabled || false
              }
              render={({ field }) => (
                <Switch
                  checked={!field.value}
      ...
      >
        <form
          onSubmit={handleSubmit(handleSubmitProductType)}
          className="w-full"
        >
