  ...
  return (
    <div className='flex flex-col items-center justify-center w-screen h-screen gap-12 py-8 '>
      ...
      <div className='flex flex-col items-center gap-4'>
        <h1 className='text-3xl font-medium text-center'>Bạn không có quyền truy cập </h1>
        <p className='text-xl text-center'>Bạn đã thử truy cập vào một trang mà bạn không có quyền hạn trước.</p>
        <BaseButton
          override={'black'}
          onClick={() => {
            clearLS();
