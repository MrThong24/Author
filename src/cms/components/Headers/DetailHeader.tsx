...
const DetailHeader: React.FC<DetailHeader> = ({ children, title, handleBack, rightElement }) => {
  return (
    <div className='w-full'>
      <div className='flex flex-wrap justify-between w-full flex-1'>
        <button className='flex items-center gap-2 mb-4 flex-1' onClick={handleBack}>
